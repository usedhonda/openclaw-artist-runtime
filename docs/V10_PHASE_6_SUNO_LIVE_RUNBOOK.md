...
### v10.4 (基盤)
- ✅ Phase 1 (tarball narrowing): commit済み、pack/import smoke pass
- ✅ Phase 2 (knowledge clean room reimpl): commit済み (v10.6 で full bundle へ更新済み)
...
### v10.6 (sunomanual full bundle)
- ✅ Phase A/B: `sunomanual` full knowledge bundle + lyrics/style/exclude synthesis prompt 統合済み
- ✅ Phase C: R6 tarball cap は撤廃。pack size は参考値のみで、enforcement しない
...
- ✅ v10.6 で tarball R6 cap は撤廃済み (現参考値: 約317 kB / enforcement なし)
...
# tarball サイズ確認 (v10.6 以降は参考値のみ、R6 cap enforcement なし)
