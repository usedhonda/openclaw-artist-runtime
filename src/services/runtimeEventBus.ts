...
export type RuntimeEvent =
  ...
  | { type: "suno_human_assist_requested"; songId: string; title: string; timeoutMinutes: number; mode?: "captcha_fallback" | "manual_submit"; recommendation?: string; timestamp: number }
