...
export const songStatuses = ["idea", "brief", "lyrics", "suno_prompt_pack", "suno_running", "takes_imported", "take_selected", "social_assets", "scheduled", "published", "archived", "discarded", "failed"] as const;
